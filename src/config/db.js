...
async function initMySQLSchema(pool) {
  ...
  const alters = [
    ...
    'ALTER TABLE events ADD COLUMN spot_registration TINYINT(1) NOT NULL DEFAULT 0',
...
async function initSQLiteSchema(client) {
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS events (
      ...
      spot_registration INTEGER NOT NULL DEFAULT 0,
  ...
  const migrations = [
    ...
    `ALTER TABLE events ADD COLUMN spot_registration INTEGER NOT NULL DEFAULT 0`,
